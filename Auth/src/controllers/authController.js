...
async function getUserAddresses(req,res){
    ...
    res.status(200).json({
        message:"User addresses fetched sucessfully!",
        addresses:user.addresses
...
module.exports = { registerUser, loginUser, getUserDetails, logoutUser, getUserAddresses, addUserAddress, deleteUserAddress}
